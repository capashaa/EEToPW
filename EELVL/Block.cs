...
namespace EELVL
{
	...
	public static class Blocks
	{
		...
		internal static (Block b, int l, IEnumerable<(ushort, ushort)> locs) Read(AS3BinaryReader reader)
		{
			...
			return (b, layer, xs.Zip(ys, (x, y) => (x, y)));
		}

		internal static void Write(AS3BinaryWriter writer, Block block, int l, IEnumerable<(ushort x, ushort y)> locs)
		{
			writer.WriteInt(block.BlockID);
			writer.WriteInt(l);
			writer.WriteUShortArray(locs.Select(loc => loc.x).ToArray());
			writer.WriteUShortArray(locs.Select(loc => loc.y).ToArray());
		...
		public class MorphableBlock : Block
		{
			...
			public override int GetHashCode()
				=> HashCode.Combine(base.GetHashCode(), Morph);
		}
		...
		public class RotatableBlock : Block
		{
			...
			public override int GetHashCode()
				=> HashCode.Combine(base.GetHashCode(), Rotation);
		}
		...
		public class NumberBlock : Block
		{
			...
			public override int GetHashCode()
				=> HashCode.Combine(base.GetHashCode(), Number);
		}
		...
		public class EnumerableBlock : Block
		{
			...
			public override int GetHashCode()
				=> HashCode.Combine(base.GetHashCode(), Variant);
		}
		...
		public class MusicBlock : Block
		{
			...
			public override int GetHashCode()
				=> HashCode.Combine(base.GetHashCode(), Note);
		}
		...
		public class PortalBlock : RotatableBlock
		{
			...
			public override int GetHashCode()
				=> HashCode.Combine(base.GetHashCode(), ID, Target);
		}
		...
		public class WorldPortalBlock : Block
		{
			...
			public override int GetHashCode()
				=> HashCode.Combine(base.GetHashCode(), Target, Spawn);
		}
		...
		public class LabelBlock : Block
		{
			...
			public override int GetHashCode()
				=> HashCode.Combine(base.GetHashCode(), Text, Color, Wrap);
		}
		...
		public class NPCBlock : Block
		{
			...
			public override int GetHashCode()
				=> HashCode.Combine(base.GetHashCode(), Name, Message1, Message2, Message3);
		}
	}
}
